...
CREATE TABLE public.questions (
    ...
    updated_at timestamp(6) without time zone NOT NULL,
    user_id bigint,
    status character varying DEFAULT 'unanswered'::character varying,
    category_id integer
);
...
CREATE INDEX index_links_on_linkable_type_and_linkable_id ON public.links USING btree (linkable_type, linkable_id);
...
--
-- Name: index_subscriptions_on_question_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_subscriptions_on_question_id ON public.subscriptions USING btree (question_id);
...
--
-- Name: subscriptions fk_rails_3f3e620f91; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.subscriptions
    ADD CONSTRAINT fk_rails_3f3e620f91 FOREIGN KEY (question_id) REFERENCES public.questions(id);
